...
export default function Button(props: ButtonsProps) {
  ...
  return (
    <div className="text-lg text-white flex flex-wrap justify-center">
      <button
        onClick={() => setType("artists")}
        className={`px-5 py-2 border border-white rounded-l-full ${
      ...
      <button
        ...
        className={`px-5 py-2 border border-white rounded-r-full ${
